...
INSERT INTO public.movies(title, status, year, release_date,
                          "cast", overview, cover, created_at,
                          updated_at)
VALUES ('Batman Begins', 'Disponível', 2005,
...
INSERT INTO public.movies(title, status, year, release_date,
                          "cast", overview, cover, created_at,
                          updated_at)
VALUES ('Batman O Cavaleiro das Trevas',
...
INSERT INTO public.movies(title, status, year, release_date,
                          "cast", overview, cover, created_at,
                          updated_at)
VALUES ('Vingadores Ultimato', 'Disponível',
...
INSERT INTO public.movies(title, status, year, release_date,
                          "cast", overview, cover, created_at,
                          updated_at)
VALUES ('Coringa', 'Em breve', 2019, '01/12/2020',
...
INSERT INTO public.movies(title, status, year, release_date,
                          "cast", overview, cover, created_at,
                          updated_at)
VALUES ('Deadpool 2', 'Disponível', 2018,
